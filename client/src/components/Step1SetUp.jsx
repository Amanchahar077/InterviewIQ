...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            ...
            console.log(error)
            setErrorMessage(error.response?.data?.message || "Resume analysis failed. Please try again.")
            setAnalyzing(false);
        }
    }
    ...
    const handleStart = async () => {
        ...
        try {
           ...
           onStart(result.data)
            ...
            console.log(error)
            setErrorMessage(error.response?.data?.message || "Unable to start interview. Please try again.")
            setLoading(false)
        }
    }
    return (
                            ...
                            <div className='rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700'>
                                ...
                                {errorMessage.toLowerCase().includes("credits") && (
                                    <button
                                        ...
                                        className='mt-3 rounded-lg bg-red-600 px-4 py-2 text-white font-semibold hover:bg-red-700 transition'>
                                        Buy Credits
                                    </button>
                                )}
                            </div>
